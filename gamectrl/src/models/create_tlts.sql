...
DROP TABLE IF EXISTS TLT_ISSUE_STATUS_PARAMS;

CREATE TABLE TLT_ISSUE_STATUS_PARAMS (
  ...
  STATE VARCHAR(1) NOT NULL DEFAULT '1' COMMENT '0无效 1有效',
  PRIMARY KEY (GEN_ID)
)  ENGINE=INNODB DEFAULT CHARSET=UTF8 COMMENT='期号时间设置表，是批量生成期号的基础';
create index IDX_TLT_ISSUE_STATUS_PARAMS_LTYPE on TLT_ISSUE_STATUS_PARAMS
(
   LTYPE
);
