...
(
   WIN_NO                 VARCHAR(64) NOT NULL COMMENT '主键',
   TICK_NO             VARCHAR(64) NOT NULL COMMENT '票号',
   BET_NO              VARCHAR(64) NOT NULL COMMENT '注号',
   MERCHANTID          VARCHAR(64) NOT NULL COMMENT '商户编号',
...
(
   REWARD_NO                 VARCHAR(64) NOT NULL COMMENT '主键',
   TICK_NO             VARCHAR(64) NOT NULL COMMENT '票号',
   BET_NO              VARCHAR(64) NOT NULL COMMENT '注号',
   MERCHANTID          VARCHAR(64) NOT NULL COMMENT '商户编号',
   USER_ID				VARCHAR(64) NOT NULL COMMENT '用户编号',
   ...
   REWARD_TYPE			VARCHAR(32) COMMENT '返点类型',
   REWARD_DESC			VARCHAR(128) COMMENT '返点内容描述',
