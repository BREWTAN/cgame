...
create index IDX_TLT_ISSUE_ISSUE_NO_STATUS on TLT_ISSUE
(
   ISSUE_NO,ISSUE_STATUS
);
...
CREATE TABLE TLT_ISSUE_FLOWS (
  ...
  GS_ORDER VARCHAR(16) DEFAULT '999' COMMENT '状态序号',
...
DROP TABLE  IF EXISTS TLT_CORE_TICK;

CREATE TABLE TLT_CORE_TICK
(
