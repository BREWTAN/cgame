...
CREATE TABLE TLT_ISSUE (
  ...
  ISSUE_STATUS VARCHAR(1) DEFAULT '0' COMMENT '状态:0:初始化，1:当前期,2:关闭期(封闭投注)，3:期后处理中,4:追期中，8:结束,9:无效',
...
CREATE TABLE TLT_ISSUE_STEPS (
  ...
  LTYPE VARCHAR(32) NOT NULL COMMENT '所属彩种，对应TLT_TYPE.LTYPE_ID',
  ISSUE_NO VARCHAR(64) NOT NULL DEFAULT '' COMMENT '期号',
  STEP_STATUS VARCHAR(1) DEFAULT '0' COMMENT '状态:0:初始化，1:当前期,3:期后处理中,4:节点实际处理中,5:节点处理完成,6:节点处理异常，8:结束,9:无效',
...
CREATE TABLE TLT_ISSUE_HIS (
  ...
  ISSUE_STATUS VARCHAR(1) DEFAULT '0' COMMENT '状态:0:初始化，1:当前期,3:期后处理中，8:结束,9:无效',
