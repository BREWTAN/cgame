...
GL_CQSSC_Caculator = {
    ...
    wgCountByDoubleZuhe:(playballs,params) ->
        lines = playballs.split(",")
        ...
        line0js.forEach( (a) ->
            line1js.forEach( (b) ->
                ...
                if unique.length == params[0]+params[1] then counter++;
                    #console.log("w="+w)
            )
        )
    ...
    getWagerCount:(wagername,playballs) ->
        ...
        if gl_playChecker == null
            gl_playChecker = {
                  ...
                  "五星组合": [@wgCountByFushi,5]
                  "五星组选120": [@wgCountByZuhe,5]
                  "五星组选60": [@wgCountByDoubleZuhe,[1,3]]
                  "五星组选30": [@wgCountByDoubleZuhe,[2,1]]
                  "五星组选20": [@wgCountByDoubleZuhe,[1,2]]
                  "五星组选10": [@wgCountByDoubleZuhe,[1,1]]
                  "五星组选5": [@wgCountByDoubleZuhe,[1,1]]

                  "四星组合": [@wgCountByFushi,4]
                  "四星单式": [@wgCountByTexts,4]
                  "四星复式": [@wgCountByFushi,4]
                  "四星组选24": [@wgCountByZuhe,4]
                  "四星组选12": [@wgCountByDoubleZuhe,[1,2]]
                  "四星组选6": [@wgCountByZuhe,2]
                  "四星组选4": [@wgCountByDoubleZuhe,[1,1]]
                  ...
                  "不定胆后三一码不定胆": [@wgCountByZuhe,1]
                  "不定胆后三二码不定胆": [@wgCountByZuhe,2]
                  "不定胆前三一码不定胆": [@wgCountByZuhe,1]
                  "不定胆前三二码不定胆": [@wgCountByZuhe,2]
