...
public interface TLTBetAutoMapper extends StaticTableDaoSupport<TLTBetAuto, TLTBetAutoExample, TLTBetAutoKey> {
    ...
    @Insert({
        ...
        "TOTAL_BET_AMOUNTS, TOTAL_BET_COUNTS, ",
        ...
        "#{totalBetAmounts,jdbcType=DECIMAL}, #{totalBetCounts,jdbcType=DECIMAL}, ",
    ...
    @Results({
        ...
        @Result(column="TOTAL_BET_AMOUNTS", property="totalBetAmounts", jdbcType=JdbcType.DECIMAL),
        @Result(column="TOTAL_BET_COUNTS", property="totalBetCounts", jdbcType=JdbcType.DECIMAL),
    ...
    @Select({
        ...
        "ISSUE_NUM, TOTAL_BET_AMOUNTS, TOTAL_BET_COUNTS, COMPLETE_NUM, CANCEL_NUM, BET_NUM, ",
        "BET_DATA, BET_COINS, COMPLETE_COINS, CANCEL_COINS, MODE, TIMES, WIN_STOP, STATUS, ",
        "BET_NO",
        "from TLT_BET_AUTO",
        "where AUTOBET_NO = #{autobetNo,jdbcType=VARCHAR}"
    })
    ...
    @Update({
        ...
        "set USER_ID = #{userId,jdbcType=VARCHAR},",
          ...
          "TOTAL_BET_AMOUNTS = #{totalBetAmounts,jdbcType=DECIMAL},",
          "TOTAL_BET_COUNTS = #{totalBetCounts,jdbcType=DECIMAL},",
