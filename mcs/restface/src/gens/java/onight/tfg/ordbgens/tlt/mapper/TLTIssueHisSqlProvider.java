...
import onight.tfg.ordbgens.tlt.entity.TLTIssueHisExample.Criterion;
import onight.tfg.ordbgens.tlt.entity.TLTIssueHisExample;

public class TLTIssueHisSqlProvider {
     ...
     */
    public String countByExample(TLTIssueHisExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("TLT_ISSUE_HIS");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String deleteByExample(TLTIssueHisExample example) {
        BEGIN();
        DELETE_FROM("TLT_ISSUE_HIS");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String insertSelective(TLTIssueHis record) {
        BEGIN();
        INSERT_INTO("TLT_ISSUE_HIS");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String selectByExample(TLTIssueHisExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TLTIssueHis record = (TLTIssueHis) parameter.get("record");
        TLTIssueHisExample example = (TLTIssueHisExample) parameter.get("example");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String updateByPrimaryKeySelective(TLTIssueHis record) {
        BEGIN();
        UPDATE("TLT_ISSUE_HIS");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    protected void applyWhere(TLTIssueHisExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
