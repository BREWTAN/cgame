...
import onight.tfg.ordbgens.tlt.entity.TLTPlayvgroupExample.Criterion;
import onight.tfg.ordbgens.tlt.entity.TLTPlayvgroupExample;

public class TLTPlayvgroupSqlProvider {
     ...
     */
    public String countByExample(TLTPlayvgroupExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("TLT_PLAYVGROUP");
     ...
     * @mbggenerated Sat Apr 16 00:18:59 CST 2016
     */
    public String deleteByExample(TLTPlayvgroupExample example) {
        BEGIN();
        DELETE_FROM("TLT_PLAYVGROUP");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sat Apr 16 00:18:59 CST 2016
     */
    public String insertSelective(TLTPlayvgroup record) {
        BEGIN();
        INSERT_INTO("TLT_PLAYVGROUP");
        ...
        if (record.getDefaultPg() != null) {
            VALUES("DEFAULT_PG", "#{defaultPg,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Sat Apr 16 00:18:59 CST 2016
     */
    public String selectByExample(TLTPlayvgroupExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TLTPlayvgroup record = (TLTPlayvgroup) parameter.get("record");
        TLTPlayvgroupExample example = (TLTPlayvgroupExample) parameter.get("example");
        ...
        if (record.getDefaultPg() != null) {
            SET("DEFAULT_PG = #{record.defaultPg,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Sat Apr 16 00:18:59 CST 2016
     */
    public String updateByPrimaryKeySelective(TLTPlayvgroup record) {
        BEGIN();
        UPDATE("TLT_PLAYVGROUP");
        ...
        if (record.getDefaultPg() != null) {
            SET("DEFAULT_PG = #{defaultPg,jdbcType=INTEGER}");
        }
     ...
     * @mbggenerated Sat Apr 16 00:18:59 CST 2016
     */
    protected void applyWhere(TLTPlayvgroupExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
