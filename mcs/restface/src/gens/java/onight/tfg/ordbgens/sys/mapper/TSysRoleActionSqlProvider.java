...
import onight.tfg.ordbgens.sys.entity.TSysRoleActionExample.Criterion;
import onight.tfg.ordbgens.sys.entity.TSysRoleActionExample;

public class TSysRoleActionSqlProvider {
     ...
     */
    public String countByExample(TSysRoleActionExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String deleteByExample(TSysRoleActionExample example) {
        BEGIN();
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String insertSelective(TSysRoleAction record) {
        BEGIN();
        ...
        if (record.getStatus() != null) {
            VALUES("STATUS", "#{status,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String selectByExample(TSysRoleActionExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TSysRoleAction record = (TSysRoleAction) parameter.get("record");
        TSysRoleActionExample example = (TSysRoleActionExample) parameter.get("example");
        ...
        if (record.getStatus() != null) {
            SET("STATUS = #{record.status,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String updateByPrimaryKeySelective(TSysRoleAction record) {
        BEGIN();
        UPDATE("T_SYS_ROLE_ACTION");
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    protected void applyWhere(TSysRoleActionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
