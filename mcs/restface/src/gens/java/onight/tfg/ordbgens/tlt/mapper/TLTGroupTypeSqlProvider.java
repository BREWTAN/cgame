...
import onight.tfg.ordbgens.tlt.entity.TLTGroupTypeExample.Criterion;
import onight.tfg.ordbgens.tlt.entity.TLTGroupTypeExample;

public class TLTGroupTypeSqlProvider {
     ...
     */
    public String countByExample(TLTGroupTypeExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("TLT_GROUP_TYPE");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String deleteByExample(TLTGroupTypeExample example) {
        BEGIN();
        DELETE_FROM("TLT_GROUP_TYPE");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String insertSelective(TLTGroupType record) {
        BEGIN();
        INSERT_INTO("TLT_GROUP_TYPE");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String selectByExample(TLTGroupTypeExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("GROUP_TYPE");
        } else {
            SELECT("GROUP_TYPE");
        }
        SELECT("CN_NAME");
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TLTGroupType record = (TLTGroupType) parameter.get("record");
        TLTGroupTypeExample example = (TLTGroupTypeExample) parameter.get("example");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    public String updateByPrimaryKeySelective(TLTGroupType record) {
        BEGIN();
        UPDATE("TLT_GROUP_TYPE");
     ...
     * @mbggenerated Thu Apr 07 16:23:07 CST 2016
     */
    protected void applyWhere(TLTGroupTypeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
