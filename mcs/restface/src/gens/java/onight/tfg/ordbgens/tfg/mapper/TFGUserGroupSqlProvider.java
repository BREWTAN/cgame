...
import onight.tfg.ordbgens.tfg.entity.TFGUserGroupExample.Criterion;
import onight.tfg.ordbgens.tfg.entity.TFGUserGroupExample;

public class TFGUserGroupSqlProvider {
     ...
     */
    public String countByExample(TFGUserGroupExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("TFG_USER_GROUP");
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String deleteByExample(TFGUserGroupExample example) {
        BEGIN();
        DELETE_FROM("TFG_USER_GROUP");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String insertSelective(TFGUserGroup record) {
        BEGIN();
        INSERT_INTO("TFG_USER_GROUP");
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String selectByExample(TFGUserGroupExample example) {
        BEGIN();
        if (example != null && example.isDistinct()) {
            SELECT_DISTINCT("USER_GROUP_ID");
        } else {
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TFGUserGroup record = (TFGUserGroup) parameter.get("record");
        TFGUserGroupExample example = (TFGUserGroupExample) parameter.get("example");
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    public String updateByPrimaryKeySelective(TFGUserGroup record) {
        BEGIN();
        UPDATE("TFG_USER_GROUP");
     ...
     * @mbggenerated Sun Apr 10 15:45:54 CST 2016
     */
    protected void applyWhere(TFGUserGroupExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
