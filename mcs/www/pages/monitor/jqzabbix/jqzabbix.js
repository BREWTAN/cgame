...
function createSyncOption(method, params, success, error, complete) {
...
this.sendSyncRequest = function(method, params, success, error, complete) {
	
	return $.ajax(createSyncOption(method, params, success, error, complete));
}
