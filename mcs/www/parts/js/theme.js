/**
 script to handle the theme demo
**/
var Theme = function () {
    ...
    var handleTheme = function () {
    	...
    	if(getCookie('color')!=null) {themeColor=getCookie('color');themeColor=themeColor.substring(1,themeColor.length-1);}
    	setColor(themeColor);
    };
