	               ...
	               diag=bootbox.dialog({
	                   ...
	                   buttons: {
	                       success: {
	                           ...
	                           callback: function() {
	                               var sendjson = {};
	                               var   ck_array = new  Array();        //定义一个chebox数组
	                               $.each($('#'+formId+' input'), function(index, val) {
	                                   ...
	                                   }else if(val.type == "checkbox"){ //checkbox
                                    	   console.log("is_ckbox   "+val.checked);
                                    	   if(val.checked)
                                    		   ck_array.push(val);   
                                       }else if(val.type == "radio"){  //radio
                                    	   console.log("is_radio   "+val.checked);
                                           if(val.checked)
                                        	   sendjson[val.name] = val.value;    	               	   
                                       }else if(val.type == "text"){ //text
                                    	   sendjson[val.name] = val.value;
                                       }    
                                   ...
                                   for(var i=0; i<ck_array.length;i++){
                                	   var cv = "";
                                	   if(i==0){
                                		   sendjson[ck_array[i].name] =  ck_array[i].value;
                                	   }else{
                                		   if(ck_array[i].name == ck_array[i-1].name){
                                			   sendjson[ck_array[i].name] += ";"+ck_array[i].value;
                                		   }else{
                                			   sendjson[ck_array[i].name] =  ck_array[i].value;
                                		   }
	                               ...
	                               $.each($('#'+formId+' textarea'), function(index, val) {
                                       console.log(val.name+"::"+val.value);
                                       if (val.name == "_id"||!val.name||val.name.length==0) return;
                                       sendjson[val.name] = val.value;
                                   });
                           ...
                           buttons: {
                               success: {
                                   ...
                                   callback: function() {
                                       ...
                                       //添加checkbox元素
                                       console.log("len   "+ck_array.length);
                                       console.log("cks   "+ck_array);
                                       for(var i=0; i<ck_array.length;i++){
                                    	   var cv = "";
                                    	   console.log("in");
                                    	   if(i==0){
                                    		   console.log("i   "+i);
                                    		   moditem[ck_array[i].name] =  ck_array[i].value;
                                    	   }else{
                                    		   console.log("i   "+ck_array[i].name);
                                    		   console.log("i-1   "+ck_array[i-1].name);
                                    		   if(ck_array[i].name == ck_array[i-1].name){
                                    			   console.log("same in  ");
                                    			   moditem[ck_array[i].name] += ";"+ck_array[i].value;
                                    		   }else{
