...
import onight.tfg.ordbgens.tfc.entity.TFCUserLockExample.Criterion;
import onight.tfg.ordbgens.tfc.entity.TFCUserLockExample;

public class TFCUserLockSqlProvider {
     ...
     */
    public String countByExample(TFCUserLockExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("TFC_USER_LOCK");
     ...
     * @mbggenerated Fri Apr 15 21:03:14 CST 2016
     */
    public String deleteByExample(TFCUserLockExample example) {
        BEGIN();
        DELETE_FROM("TFC_USER_LOCK");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Fri Apr 15 21:03:14 CST 2016
     */
    public String insertSelective(TFCUserLock record) {
        BEGIN();
        INSERT_INTO("TFC_USER_LOCK");
        ...
        if (record.getRecDate() != null) {
            VALUES("REC_DATE", "#{recDate,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Fri Apr 15 21:03:14 CST 2016
     */
    public String selectByExample(TFCUserLockExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TFCUserLock record = (TFCUserLock) parameter.get("record");
        TFCUserLockExample example = (TFCUserLockExample) parameter.get("example");
        ...
        if (record.getRecDate() != null) {
            SET("REC_DATE = #{record.recDate,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Fri Apr 15 21:03:14 CST 2016
     */
    public String updateByPrimaryKeySelective(TFCUserLock record) {
        BEGIN();
        UPDATE("TFC_USER_LOCK");
        ...
        if (record.getCoinRowId() != null) {
            SET("COIN_ROW_ID = #{coinRowId,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRecDate() != null) {
            SET("REC_DATE = #{recDate,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Fri Apr 15 21:03:14 CST 2016
     */
    protected void applyWhere(TFCUserLockExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
