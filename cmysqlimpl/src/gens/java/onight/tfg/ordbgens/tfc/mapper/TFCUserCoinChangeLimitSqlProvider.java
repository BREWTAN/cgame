...
import onight.tfg.ordbgens.tfc.entity.TFCUserCoinChangeLimitExample.Criterion;
import onight.tfg.ordbgens.tfc.entity.TFCUserCoinChangeLimitExample;

public class TFCUserCoinChangeLimitSqlProvider {
     ...
     */
    public String countByExample(TFCUserCoinChangeLimitExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Sun Apr 10 15:45:37 CST 2016
     */
    public String deleteByExample(TFCUserCoinChangeLimitExample example) {
        BEGIN();
        DELETE_FROM("TFC_USER_COIN_CHANGE_LIMIT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sun Apr 10 15:45:37 CST 2016
     */
    public String insertSelective(TFCUserCoinChangeLimit record) {
        BEGIN();
        INSERT_INTO("TFC_USER_COIN_CHANGE_LIMIT");
        ...
        if (record.getInNum() != null) {
            VALUES("IN_NUM", "#{inNum,jdbcType=BIGINT}");
        }
        
        if (record.getOutNum() != null) {
            VALUES("OUT_NUM", "#{outNum,jdbcType=BIGINT}");
        }
        ...
        if (record.getResettime() != null) {
            VALUES("RESETTIME", "#{resettime,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Sun Apr 10 15:45:37 CST 2016
     */
    public String selectByExample(TFCUserCoinChangeLimitExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TFCUserCoinChangeLimit record = (TFCUserCoinChangeLimit) parameter.get("record");
        TFCUserCoinChangeLimitExample example = (TFCUserCoinChangeLimitExample) parameter.get("example");
        ...
        if (record.getInNum() != null) {
            SET("IN_NUM = #{record.inNum,jdbcType=BIGINT}");
        }
        
        if (record.getOutNum() != null) {
            SET("OUT_NUM = #{record.outNum,jdbcType=BIGINT}");
        }
        ...
        if (record.getResettime() != null) {
            SET("RESETTIME = #{record.resettime,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Sun Apr 10 15:45:37 CST 2016
     */
    public String updateByPrimaryKeySelective(TFCUserCoinChangeLimit record) {
        BEGIN();
        UPDATE("TFC_USER_COIN_CHANGE_LIMIT");
        ...
        if (record.getOutNum() != null) {
            SET("OUT_NUM = #{outNum,jdbcType=BIGINT}");
        }
        ...
        if (record.getResettime() != null) {
            SET("RESETTIME = #{resettime,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Sun Apr 10 15:45:37 CST 2016
     */
    protected void applyWhere(TFCUserCoinChangeLimitExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
