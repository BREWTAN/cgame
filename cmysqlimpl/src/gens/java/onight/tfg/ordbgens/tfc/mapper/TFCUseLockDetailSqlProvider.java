...
import onight.tfg.ordbgens.tfc.entity.TFCUseLockDetailExample.Criterion;
import onight.tfg.ordbgens.tfc.entity.TFCUseLockDetailExample;

public class TFCUseLockDetailSqlProvider {
     ...
     */
    public String countByExample(TFCUseLockDetailExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Sat Apr 16 00:19:00 CST 2016
     */
    public String deleteByExample(TFCUseLockDetailExample example) {
        BEGIN();
        DELETE_FROM("TFC_USE_LOCK_DETAIL");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sat Apr 16 00:19:00 CST 2016
     */
    public String insertSelective(TFCUseLockDetail record) {
        BEGIN();
        INSERT_INTO("TFC_USE_LOCK_DETAIL");
        ...
        if (record.getLockNum() != null) {
            VALUES("LOCK_NUM", "#{lockNum,jdbcType=BIGINT}");
        }
        ...
        if (record.getOtherLockNum() != null) {
            VALUES("OTHER_LOCK_NUM", "#{otherLockNum,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated Sat Apr 16 00:19:00 CST 2016
     */
    public String selectByExample(TFCUseLockDetailExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TFCUseLockDetail record = (TFCUseLockDetail) parameter.get("record");
        TFCUseLockDetailExample example = (TFCUseLockDetailExample) parameter.get("example");
        ...
        if (record.getServerName() != null) {
            SET("SERVER_NAME = #{record.serverName,jdbcType=VARCHAR}");
        }
        
        if (record.getLockNum() != null) {
            SET("LOCK_NUM = #{record.lockNum,jdbcType=BIGINT}");
        }
        ...
        if (record.getOtherLockNum() != null) {
            SET("OTHER_LOCK_NUM = #{record.otherLockNum,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated Sat Apr 16 00:19:00 CST 2016
     */
    public String updateByPrimaryKeySelective(TFCUseLockDetail record) {
        BEGIN();
        UPDATE("TFC_USE_LOCK_DETAIL");
        ...
        if (record.getLockNum() != null) {
            SET("LOCK_NUM = #{lockNum,jdbcType=BIGINT}");
        }
        ...
        if (record.getOtherLockNum() != null) {
            SET("OTHER_LOCK_NUM = #{otherLockNum,jdbcType=BIGINT}");
        }
     ...
     * @mbggenerated Sat Apr 16 00:19:00 CST 2016
     */
    protected void applyWhere(TFCUseLockDetailExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
