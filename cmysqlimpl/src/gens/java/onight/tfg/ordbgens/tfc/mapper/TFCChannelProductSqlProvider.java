...
import onight.tfg.ordbgens.tfc.entity.TFCChannelProductExample.Criterion;
import onight.tfg.ordbgens.tfc.entity.TFCChannelProductExample;

public class TFCChannelProductSqlProvider {
     ...
     */
    public String countByExample(TFCChannelProductExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Thu Apr 14 00:28:13 CST 2016
     */
    public String deleteByExample(TFCChannelProductExample example) {
        BEGIN();
        DELETE_FROM("TFC_CHANNEL_PRODUCT");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu Apr 14 00:28:13 CST 2016
     */
    public String insertSelective(TFCChannelProduct record) {
        BEGIN();
        INSERT_INTO("TFC_CHANNEL_PRODUCT");
        ...
        if (record.getRectime() != null) {
            VALUES("RECTIME", "#{rectime,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Thu Apr 14 00:28:13 CST 2016
     */
    public String selectByExample(TFCChannelProductExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TFCChannelProduct record = (TFCChannelProduct) parameter.get("record");
        TFCChannelProductExample example = (TFCChannelProductExample) parameter.get("example");
        ...
        if (record.getRectime() != null) {
            SET("RECTIME = #{record.rectime,jdbcType=TIMESTAMP}");
        }
     ...
     * @mbggenerated Thu Apr 14 00:28:13 CST 2016
     */
    public String updateByPrimaryKeySelective(TFCChannelProduct record) {
        BEGIN();
        UPDATE("TFC_CHANNEL_PRODUCT");
     ...
     * @mbggenerated Thu Apr 14 00:28:13 CST 2016
     */
    protected void applyWhere(TFCChannelProductExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
