...
public interface TLTCoreRewardMapper extends StaticTableDaoSupport<TLTCoreReward, TLTCoreRewardExample, TLTCoreRewardKey> {
     ...
     */
    @Insert({
        "insert into TLT_CORE_REWARD (REWARD_NO, TICK_NO, ",
        "BET_NO, MERCHANTID, ",
        "USER_ID, ISSUE_NO, ",
        "LTYPE, PLAY_TYPE, ",
        ...
        "#{rewardAmount,jdbcType=DECIMAL}, #{rewardType,jdbcType=VARCHAR}, ",
        "#{rewardDesc,jdbcType=VARCHAR}, #{rewardRatio,jdbcType=DECIMAL}, ",
    ...
    @Results({
        @Result(column="REWARD_NO", property="rewardNo", jdbcType=JdbcType.VARCHAR, id=true),
        ...
        @Result(column="REWARD_DESC", property="rewardDesc", jdbcType=JdbcType.VARCHAR),
    ...
    @Select({
        ...
        "FUND_REWARD_DATE, FUND_REWARD_STATUS, FUND_CANCEL_DATE, SERIAL_NUM, STATUS",
