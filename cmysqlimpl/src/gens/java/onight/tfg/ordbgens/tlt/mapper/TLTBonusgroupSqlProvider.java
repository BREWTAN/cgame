...
import onight.tfg.ordbgens.tlt.entity.TLTBonusgroupExample.Criterion;
import onight.tfg.ordbgens.tlt.entity.TLTBonusgroupExample;

public class TLTBonusgroupSqlProvider {
     ...
     */
    public String countByExample(TLTBonusgroupExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("TLT_BONUSGROUP");
     ...
     * @mbggenerated Thu Apr 14 00:28:14 CST 2016
     */
    public String deleteByExample(TLTBonusgroupExample example) {
        BEGIN();
        DELETE_FROM("TLT_BONUSGROUP");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Thu Apr 14 00:28:14 CST 2016
     */
    public String insertSelective(TLTBonusgroup record) {
        BEGIN();
        INSERT_INTO("TLT_BONUSGROUP");
     ...
     * @mbggenerated Thu Apr 14 00:28:14 CST 2016
     */
    public String selectByExample(TLTBonusgroupExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TLTBonusgroup record = (TLTBonusgroup) parameter.get("record");
        TLTBonusgroupExample example = (TLTBonusgroupExample) parameter.get("example");
     ...
     * @mbggenerated Thu Apr 14 00:28:14 CST 2016
     */
    public String updateByPrimaryKeySelective(TLTBonusgroup record) {
        BEGIN();
        UPDATE("TLT_BONUSGROUP");
     ...
     * @mbggenerated Thu Apr 14 00:28:14 CST 2016
     */
    protected void applyWhere(TLTBonusgroupExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
