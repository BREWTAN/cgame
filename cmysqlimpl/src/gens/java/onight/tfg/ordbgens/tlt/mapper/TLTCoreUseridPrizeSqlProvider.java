...
import onight.tfg.ordbgens.tlt.entity.TLTCoreUseridPrizeExample.Criterion;
import onight.tfg.ordbgens.tlt.entity.TLTCoreUseridPrizeExample;

public class TLTCoreUseridPrizeSqlProvider {
     ...
     */
    public String countByExample(TLTCoreUseridPrizeExample example) {
        BEGIN();
        SELECT("count(*)");
     ...
     * @mbggenerated Sat Apr 16 13:41:12 CST 2016
     */
    public String deleteByExample(TLTCoreUseridPrizeExample example) {
        BEGIN();
        DELETE_FROM("TLT_CORE_USERID_PRIZE");
        applyWhere(example, false);
        return SQL();
    }
     ...
     * @mbggenerated Sat Apr 16 13:41:12 CST 2016
     */
    public String insertSelective(TLTCoreUseridPrize record) {
        BEGIN();
        INSERT_INTO("TLT_CORE_USERID_PRIZE");
     ...
     * @mbggenerated Sat Apr 16 13:41:12 CST 2016
     */
    public String selectByExample(TLTCoreUseridPrizeExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        TLTCoreUseridPrize record = (TLTCoreUseridPrize) parameter.get("record");
        TLTCoreUseridPrizeExample example = (TLTCoreUseridPrizeExample) parameter.get("example");
     ...
     * @mbggenerated Sat Apr 16 13:41:12 CST 2016
     */
    public String updateByPrimaryKeySelective(TLTCoreUseridPrize record) {
        BEGIN();
        UPDATE("TLT_CORE_USERID_PRIZE");
     ...
     * @mbggenerated Sat Apr 16 13:41:12 CST 2016
     */
    protected void applyWhere(TLTCoreUseridPrizeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
