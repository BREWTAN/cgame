...
public interface TLTBetAutoMapper extends StaticTableDaoSupport<TLTBetAuto, TLTBetAutoExample, TLTBetAutoKey> {
     ...
     */
    @Insert({
        "insert into TLT_BET_AUTO (AUTOBET_NO, USER_ID, ",
        "LTYPE, LNAME, PLAY_TYPE, ",
        "LPG_ID, LP_ID, CREATE_TIME, ",
        "START_ISSUE, ISSUE_NUM, ",
        "TOTAL_TICK_AMOUNTS, TOTAL_TICK_COUNTS, ",
        "COMPLETE_NUM, CANCEL_NUM, ",
        "BET_DATA, COMPLETE_COINS, ",
        "CANCEL_COINS, MODE, ",
        "TIMES, WIN_STOP, ",
        "STATUS, TICK_NO)",
        "values (#{autobetNo,jdbcType=VARCHAR}, #{userId,jdbcType=VARCHAR}, ",
        "#{ltype,jdbcType=VARCHAR}, #{lname,jdbcType=VARCHAR}, #{playType,jdbcType=VARCHAR}, ",
        "#{lpgId,jdbcType=VARCHAR}, #{lpId,jdbcType=VARCHAR}, #{createTime,jdbcType=TIMESTAMP}, ",
        "#{startIssue,jdbcType=VARCHAR}, #{issueNum,jdbcType=INTEGER}, ",
        "#{totalTickAmounts,jdbcType=DECIMAL}, #{totalTickCounts,jdbcType=DECIMAL}, ",
        "#{completeNum,jdbcType=INTEGER}, #{cancelNum,jdbcType=INTEGER}, ",
        "#{betData,jdbcType=VARCHAR}, #{completeCoins,jdbcType=REAL}, ",
        "#{cancelCoins,jdbcType=REAL}, #{mode,jdbcType=INTEGER}, ",
        "#{times,jdbcType=INTEGER}, #{winStop,jdbcType=INTEGER}, ",
        "#{status,jdbcType=INTEGER}, #{tickNo,jdbcType=VARCHAR})"
    })
    ...
    @Results({
        @Result(column="AUTOBET_NO", property="autobetNo", jdbcType=JdbcType.VARCHAR, id=true),
        ...
        @Result(column="TOTAL_TICK_AMOUNTS", property="totalTickAmounts", jdbcType=JdbcType.DECIMAL),
        @Result(column="TOTAL_TICK_COUNTS", property="totalTickCounts", jdbcType=JdbcType.DECIMAL),
    ...
    @Select({
        "select",
        "AUTOBET_NO, USER_ID, LTYPE, LNAME, PLAY_TYPE, LPG_ID, LP_ID, CREATE_TIME, START_ISSUE, ",
        "ISSUE_NUM, TOTAL_TICK_AMOUNTS, TOTAL_TICK_COUNTS, COMPLETE_NUM, CANCEL_NUM, ",
        "BET_DATA, COMPLETE_COINS, CANCEL_COINS, MODE, TIMES, WIN_STOP, STATUS, TICK_NO",
        "from TLT_BET_AUTO",
        "where AUTOBET_NO = #{autobetNo,jdbcType=VARCHAR}"
    })
    @Results({
    ...
    @Update({
        ...
        "set USER_ID = #{userId,jdbcType=VARCHAR},",
          ...
          "TOTAL_TICK_AMOUNTS = #{totalTickAmounts,jdbcType=DECIMAL},",
          "TOTAL_TICK_COUNTS = #{totalTickCounts,jdbcType=DECIMAL},",
          ...
          "TICK_NO = #{tickNo,jdbcType=VARCHAR}",
        "where AUTOBET_NO = #{autobetNo,jdbcType=VARCHAR}"
    })
