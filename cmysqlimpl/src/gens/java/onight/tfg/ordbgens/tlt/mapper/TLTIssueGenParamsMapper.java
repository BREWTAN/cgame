...
public interface TLTIssueGenParamsMapper extends StaticTableDaoSupport<TLTIssueGenParams, TLTIssueGenParamsExample, TLTIssueGenParamsKey> {
    ...
    @Insert({
        ...
        "WAIT_RL_DUR, PRE_SALE_SEC, ",
        "PRE_CLOSE_SALE_SEC, CANCEL_DUR, ",
        "INPUT_DUR, SORT, ",
        "ENABLE)",
        ...
        "#{waitRlDur,jdbcType=INTEGER}, #{preSaleSec,jdbcType=INTEGER}, ",
        "#{preCloseSaleSec,jdbcType=INTEGER}, #{cancelDur,jdbcType=INTEGER}, ",
        "#{inputDur,jdbcType=INTEGER}, #{sort,jdbcType=INTEGER}, ",
    ...
    @Results({
        ...
        @Result(column="PRE_SALE_SEC", property="preSaleSec", jdbcType=JdbcType.INTEGER),
        @Result(column="PRE_CLOSE_SALE_SEC", property="preCloseSaleSec", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        ...
        "PRE_SALE_SEC, PRE_CLOSE_SALE_SEC, CANCEL_DUR, INPUT_DUR, SORT, ENABLE",
    ...
    @Update({
        ...
        "set LTYPE = #{ltype,jdbcType=VARCHAR},",
          ...
          "PRE_SALE_SEC = #{preSaleSec,jdbcType=INTEGER},",
          "PRE_CLOSE_SALE_SEC = #{preCloseSaleSec,jdbcType=INTEGER},",
